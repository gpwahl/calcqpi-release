...
#ifndef _qpihipkernel_h
#define _qpihipkernel_h
...
class HipQPI:public GPUQPI
{
 ...
 public:
  HipQPI(size_t wanniern,size_t kpoints,size_t n,size_t window,size_t oversamp,size_t bands,size_t maxband,bool spin,vector<wannierfunctions> &wf);
  HipQPI(size_t wanniern, size_t kpoints,size_t n,size_t window, size_t oversamp,size_t bands,flaglist &flist);
  HipQPI(size_t kpoints,size_t n,size_t bands,size_t maxbands,bool spin,vector<vector<double> > &pos,vector<double> &prearr);
